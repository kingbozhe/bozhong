	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.ICON,
				...
				"' objectType='",node.objectType,"' isAuthed='",node.isAuthed,"'>",name,"</span>");
		},
		...
		makeDOMNodeMainBefore: function(html, setting, node) {
			html.push("<li id='", node.tId, "' class='level", node.level,"' tabindex='0' hidefocus='true' treenode objectType='",node.objectType,"' isAuthed='",node.isAuthed,"'>");
		},
		...
		makeDOMNodeNameBefore: function(html, setting, node) {
			...
			html.push("<a id='", node.tId, consts.id.A, "' class='level", node.level,"' treeNode", consts.id.A," onclick=\"", (node.click || ''),
				...
				"' objectType='",node.objectType,"' isAuthed='",node.isAuthed,"'");
